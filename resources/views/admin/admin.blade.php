...
<head>
    ...
    <!-- Favicon -->
    <link href="adminF/img/favicon.ico" rel="icon">
    ...
    <link href="adminF/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="adminF/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="adminF/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="adminF/css/style.css" rel="stylesheet">
</head>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <!-- <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="adminF/img/user.jpg" alt="" style="width: 40px; height: 40px;">
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="adminF/img/user.jpg" alt="" style="width: 40px; height: 40px;">
